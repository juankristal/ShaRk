...
# CSV header row
header = ["Beatmap ID", "Collection Name", "Chart Name", "Density", "Manipulability", "Strain", "RICE TOTAL", "Inverse",
          "Release", "Hold", "LNNess", "LN TOTAL", "GLOBAL", "DT GLOBAL"]
...
if mode == "collections":
    ...
    for coll in os.listdir(colls_folder):
        ...
        fig, ((dens, inverse), (manip, release), (strain, lnness), (rice_total,
                                                                    hold), (total, ln_total)) = plt.subplots(nrows=5,
                                                                                                             ncols=2,
                                                                                                             sharex=True)
